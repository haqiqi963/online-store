                ...
                <div class="flex -mx-4 flex-row relative">
                    ...
                    <div class="px-4 relative card group">
                        <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                            ...
                            <img
                                src="{{ $product->galleries()->exists() ? Storage::url($product->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAAUEBAAAACwAAAAAAQABAAACAkQBADs=' }}"
                                alt=""
                        ...
                        <a href="{{ route('frontend.details', $product->slug) }}" class="stretched-link">
                            <!-- fake children -->
                        </a>
                    </div>
