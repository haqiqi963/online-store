                ...
                <div class="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
                        ...
                        >
                            <div class="px-4 flex-none">
                                <div class="" style="width: 90px; height: 90px">
                                    <img
                                        src="{{ $cart->product->galleries()->exists() ? Storage::url($cart->product->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAAUEBAAAACwAAAAAAQABAAACAkQBADs=' }}"
                                        alt="chair-1"
                    ...
                    @empty
                        <p id="cart-empty" class="text-center py-8">
                            Ooops... Cart is empty
                            <a href="{{ route('frontend.index') }}" class="underline">Shop Now</a>
                        </p>
                    @endforelse
